        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                  ...
                  <form action="process_user_home_page.php" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                          ...
                          <input name="goalTitle" id = "goalTitleMargins"/>

                          <textarea name="goals" id="story"></textarea>
                        </p>
